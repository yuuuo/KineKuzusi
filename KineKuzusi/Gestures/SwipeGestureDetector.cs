...
namespace Kinect.Toolbox
{
    public class SwipeGestureDetector : GestureDetector
    {
        ...
        protected bool ScanPositions(Func<Vector, Vector3, bool> heightFunction, Func<Vector3, Vector3, bool> directionFunction, 
        ...
        protected override void LookForGesture()
        {
            ...
            if (ScanPositions((p1, p2) => Math.Abs(p2.Y - p1.Y) < SwipeMaximalHeight,  // Height
                ...
                SwipeMininalDuration, SwipeMaximalDuration))// Duration
            {
                RaiseGestureDetected("SwipeTolllllll");
                return;
            }
            ...
            　  (p1, p2) => p2.Y – p1.Y > -0.01f, // Progression to up
                (p1, p2) => Math.Abs (p2.Y – p1.Y) > SwipeMinimalLength/2.0,　// Length
                SwipeMininalDuration,　SwipeMaximalDuration))// Duration
            {
